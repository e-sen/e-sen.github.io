...
let AuthService = class AuthService {
    ...
    signIn(username, password) {
        return this.http.post(this.signInURI, {
            ...
            observe: 'body'
        }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(token => {
            this.token.next(token);
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('signIn', false))).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(() => {
            return true;
        }));
    }
    signOut() {
    ...
    fetchUserInfo() {
        return this.http
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])((userInfo) => this.userInfo = userInfo), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('fetchUserInfo')));
    }
    get signedIn() {
...
let CommandService = class CommandService {
    ...
    login() {
        return this.http.post(this.loginURI, {}).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(x => true), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('login', false)));
    }
    cancelOrder(orderId) {
        return this.http.delete(this.cancelOrderURI + orderId)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(() => true), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('cancelOrder', false)));
    }
    createOpening(matcherId, type, price, quantity, leverage, margin, isolate) {
        return this.http.post(this.createOpeningOrderURI, {
            ...
            margin,
            isolate
        }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(() => true), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('createOpening', false)));
    }
    createClosing(positionId, price) {
        return this.http.post(this.createClosingOrderURI, {
            positionId,
            price
        }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(() => true), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('createClosing', false)));
    }
    handleError(operation = 'operation', result) {
        return (error) => {
            console.error(operation);
...
let QueryService = class QueryService {
    ...
    fetchContracts() {
        return this.http.get(this.contractListURI)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])((page) => this.contracts = page.content))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])((page) => page.content), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('fetchContent', [])));
    }
    fetchTransaction(matcherId) {
        return this.http.get(this.transactionURI, { params: { matcherId } })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(page => this.transactions = page.content))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(page => page.content), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('fetchTransaction', [])));
    }
    fetchQuote(matcherId) {
        return this.http.get(this.quoteURI, { params: { matcherId, level: '5' } })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(quote => this.quote = quote), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('fetchQuote', {
            asks: [],
            bids: []
        })));
    }
    fetchReals(matcherId) {
        return this.http.get(this.realURI, { params: { matcherId: matcherId || this.contracts.map(x => x.matcherId) } })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(x => {
            x.forEach((item, index) => {
                this.contracts[index] = Object.assign(this.contracts[index], item);
            });
        }))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('fetchReal', [])));
    }
    fetchOrder(matcherId) {
        return this.http.get(this.orderURI, { params: { matcherId, finished: 'false' } })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(page => page.content), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('fetchOrder', [])));
    }
    fetchPosition(matcherId) {
        return this.http.get(this.positionURI, { params: { matcherId, finished: 'false' } })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(page => page.content), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('fetchPosition', [])));
    }
    fetchCashes() {
        return this.http.get(this.cashesURI)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(page => page.content));
    }
    handleError(operation = 'operation', result) {
        return (error) => {
            console.error(operation);
...
let CashComponent = class CashComponent {
    constructor(query, router, stomp) {
        this.query = query;
        this.router = router;
        this.stomp = stomp;
    ...
    ngOnInit() {
        this.router.queryParams.subscribe((x) => {
            ...
            this.matcherId = x.matcherId;
            this.cashId = this.matcherId.split('/')[1];
            this.query.fetchCashes().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((cashes => cashes.filter(cash => cash.cashId === this.cashId)))).subscribe((cash) => {
                this.cash = cash[0] || { balance: 0, cashId: this.cashId, maintenance: 0, initial: 0 };
            });
        });
        this.cashSubscribe = this.stomp.watch('/user/margin').subscribe((msg) => {
            const body = JSON.parse(msg.body);
            const event = body.event;
            if (event.cashId !== this.cashId) {
                return;
            }
            switch (body.type) {
                case 'CashBalanceIncreasedEvent': {
                    this.cash.balance += event.amount;
                    break;
                }
                ...
                case 'CashInitialIncreasedEvent': {
                    this.cash.initial += event.amount;
                    break;
                }
                ...
                case 'CashMaintenanceIncreasedEvent': {
                    this.cash.maintenance += event.amount;
                    break;
                }
...
let OrderComponent = class OrderComponent {
    constructor(query, command, router, snackBar, stomp) {
        this.query = query;
    ...
    ngOnInit() {
        this.router.queryParams.subscribe((x) => {
            ...
            this.matcherId = x.matcherId;
            this.query.fetchOrder(this.matcherId).subscribe((orders) => {
                this.orders = orders;
            });
        });
        this.ordersubscribe = this.stomp.watch('/user/order').subscribe((msg) => {
            const body = JSON.parse(msg.body);
            const event = body.event;
            switch (body.type) {
                ...
                case 'OrderClosedEvent': {
                    this.snackBar.open(`OrderClosedEvent: ${event.orderId}`, null, { duration: 1000, verticalPosition: 'top' });
                }
            }
        });
    }
    cancelOrder(orderId) {
        this.command.cancelOrder(orderId).subscribe((x) => console.log(x), (e) => {
            this.snackBar.open(e, null, { duration: 1000, verticalPosition: 'top' });
        });
    }
    ngOnDestroy() {
...
let PositionComponent = class PositionComponent {
    ...
    ngOnInit() {
        this.router.queryParams.subscribe((x) => {
            ...
            this.matcherId = x.matcherId;
            this.query.fetchPosition(this.matcherId).subscribe((orders) => {
                this.positions = orders;
            });
        });
        this.positionSubscribe = this.stomp.watch('/user/position').subscribe((msg) => {
            const body = JSON.parse(msg.body);
            const event = body.event;
            switch (body.type) {
                ...
                case 'PositionClosedEvent': {
                    this.positions = this.positions.map((it) => {
        ...
        this.interceptorSubscribe = this.stomp.watch('/user/inspector/position').subscribe((msg) => {
            const body = JSON.parse(msg.body);
            const event = body.event;
            switch (body.type) {
                ...
                case 'PositionInspectorRemovedEvent': {
                    this.positions = this.positions.map((item) => {
                        if (item.positionId === event.positionId) {
                            item.inspectors = item.inspectors.map((inspector) => {
    ...
    close(positionId) {
        this.command.createClosing(positionId, 0).subscribe((x) => {
        }, (error) => {
            this.snackBar.open(error, null, { duration: 1000, verticalPosition: 'top' });
        });
    }
};
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _stomp_ng2_stompjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @stomp/ng2-stompjs */ "./node_modules/@stomp/ng2-stompjs/fesm2015/stomp-ng2-stompjs.js");
...
let ChartsComponent = class ChartsComponent {
    constructor(sanitizer, query, router, stomp) {
    ...
    ngOnInit() {
        this.router.queryParams.subscribe((x) => {
            ...
            if (!!this.realSubscribe) {
                this.realSubscribe.unsubscribe();
            }
            this.matcherId = x.matcherId || '';
            this.realSubscribe = this.stomp.watch(`/contract/${this.matcherId}/real`).subscribe((msg) => {
                const body = JSON.parse(msg.body);
                const event = body.event;
            ...
            this.query.fetchReals([this.matcherId]).subscribe((reals) => {
                if (reals.length > 0) {
                    const real = reals[0];
                    this.ask = real.ask;
                    this.bid = real.bid;
                    ...
                    this.volume = real.volume;
                    this.time = real.time;
                }
            });
            this.src = this.sanitizer
                .bypassSecurityTrustResourceUrl(`https://trade.miex.io/tv/index.html?symbol=${this.matcherId.replace('/', '').trim()}&point=1&lan=zh&platform=demo`);
        });
    }
};
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let ControllerComponent = class ControllerComponent {
    constructor(auth, command, query, router, snackBar) {
        this.auth = auth;
        this.command = command;
        this.query = query;
        this.router = router;
    ...
    ngOnInit() {
        this.router.queryParams.subscribe((x) => {
            ...
            this.matcherId = x.matcherId;
            const cash = this.matcherId.split('/');
            this.secondary = cash[0];
            this.primary = cash[1];
            this.query.fetchReals([this.matcherId]).subscribe((x) => {
                if (x.length > 0) {
                    const real = x[0];
                    this.price = !real.bid ? 1 : real.bid;
                }
            });
        });
    }
    ngAfterViewInit() {
        this.select.selectionChange.subscribe((x) => {
            this.isMarketPrice = x.value === '0';
        });
    }
    get signedIn() {
        return this.auth.signedIn;
    ...
    create(type) {
        const margin = this.price * this.quantity / this.leverage * 1.2;
        this.command.createOpening(this.matcherId, type, this.price, this.quantity, this.leverage, margin, true).subscribe((x) => {
        }, (error) => {
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _auth_auth_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../auth/auth.service */ "./src/app/tex/auth/auth.service.ts");
/* harmony import */ var angular_gridster2__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! angular-gridster2 */ "./node_modules/angular-gridster2/fesm2015/angular-gridster2.js");
...
let HomeComponent = class HomeComponent {
    ...
    ngOnInit() {
        ...
        this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_12__["filter"])((event) => event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_11__["ActivationEnd"])).subscribe((event) => {
            this.currentMatcherId = event.snapshot.queryParams.matcherId;
        });
    }
    get loggedIn() {
        return this.auth.signedIn;
...
let MenuComponent = class MenuComponent {
    ...
    getContracts() {
        this.queryService.fetchContracts().subscribe((contracts) => {
            this.queryService.fetchReals().subscribe((x) => {
                this.contracts = this.queryService.contracts;
                this.router.navigate(['contract'], { queryParams: { matcherId: this.contracts[0].matcherId } });
            });
        });
    }
    onChange() {
...
let QuoteComponent = class QuoteComponent {
    ...
    ngOnInit() {
        this.router.queryParams.subscribe((x) => {
            ...
            if (!!this.quoteSubscribe) {
                this.quoteSubscribe.unsubscribe();
            }
            this.matcherId = x.matcherId;
            this.quoteSubscribe = this.stomp.watch(`/contract/${this.matcherId}/quote`).subscribe((msg) => {
                const body = JSON.parse(msg.body);
                const event = body.event;
                const type = body.type;
                switch (type) {
                    case 'MatcherQuoteIncreasedEvent': {
                        this.add(event.type === 1 ? 'BID' : 'ASK', event.price, event.quantity);
                        break;
                    }
                    case 'MatcherQuoteDecreasedEvent': {
                        this.remove(event.type === 1 ? 'BID' : 'ASK', event.price, event.quantity);
                        break;
                    }
                }
            });
            this.query.fetchQuote(this.matcherId).subscribe((quote) => {
                this.quote = quote;
            });
        });
    }
    add(type, price, quantity) {
        ...
        let quotes = isBid ? this.quote.bids : this.quote.asks;
        ...
        if (!isHas) {
            quotes = quotes.concat({ price, quantity });
        }
        if (isBid) {
            this.quote.bids = [...quotes];
        }
        else {
            this.quote.asks = [...quotes];
        }
    }
...
let TransactionComponent = class TransactionComponent {
    ...
    ngOnInit() {
        this.router.queryParams.subscribe((x) => {
            ...
            this.matcherId = x.matcherId;
            this.query.fetchTransaction(this.matcherId).subscribe((transactions) => this.transactions = transactions);
        });
    }
};
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    login() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.auth.signIn(this.username, this.password).subscribe({
                ...
                error: (message) => {
                    this.logging = false;
                    this.snackBar.open(message, null, { duration: 1000, horizontalPosition: 'right', verticalPosition: 'top' });
                }
            });
        });
    }
...
/* harmony import */ var angular_gridster2__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! angular-gridster2 */ "./node_modules/angular-gridster2/fesm2015/angular-gridster2.js");
...
/* harmony import */ var ng_dynamic_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ng-dynamic-component */ "./node_modules/ng-dynamic-component/bundles/ng-dynamic-component.es2015.js");
...
/* harmony import */ var _stomp_ng2_stompjs__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! @stomp/ng2-stompjs */ "./node_modules/@stomp/ng2-stompjs/fesm2015/stomp-ng2-stompjs.js");
        ...
        providers: [
            {
                ...
                useFactory: (auth) => {
                    const service = new _stomp_ng2_stompjs__WEBPACK_IMPORTED_MODULE_24__["RxStompService"]();
                    service.configure({
...
let UserComponent = class UserComponent {
    ...
    getUserInfo() {
        this.auth.fetchUserInfo().subscribe((userInfo) => {
